...
<div style="margin:10px;">
  <?php
  $query = mysqli_query($koneksi, "SELECT DISTINCT nopol FROM pelaporan");
 while( $row = mysqli_fetch_array($query)){
  ...
  echo "
  <a href='detail_kerusakan.php?kode=$nopol'><div style='float:left;background:yellow;margin:5px;padding:30px;border-radius:5px;'>
