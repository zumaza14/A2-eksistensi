  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <hr/>
<!--konten-->
<a href="data_kerusakan_berat.php" type="button" class="btn btn-primary" style="margin:10px;">+Tambah Data</a>
<br/>

  <?php
  $query = mysqli_query($koneksi, "SELECT DISTINCT nopol FROM laporan_berat");
 while( $row = mysqli_fetch_array($query)){
  ...
  echo "
  <a href='detail_kerusakan_berat.php?kode=$nopol'><div style='float:left;background:yellow;margin:5px;padding:30px;border-radius:5px;'>
