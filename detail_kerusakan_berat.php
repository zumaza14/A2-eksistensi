...
<h4 style="margin:10px;text-align:center;">DATA KENDARAAN KERUSAKAN BERAT <br/>NOMOR POLISI <?php echo $kode;?></h4>
...
<table class="table table-bordered border-primary">
  ...
  <?php
  $query = mysqli_query($koneksi, "SELECT * FROM laporan_berat WHERE nopol='$kode'");
  $no = 1;
